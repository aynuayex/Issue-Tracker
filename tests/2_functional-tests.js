  ...
  suite("Tests for Post method", function () {
    test("Create an issue with every field: POST request to /api/issues/{project}", function (done) {
      chai
        ...
        .send({
          issue_title: "testupdated1",
          issue_text: "testtesttest",
          created_by: "Ayne Abreham",
          assigned_to: "",
          status_text: "",
        })
        .end(function (err, res) {
          ...
          assert.equal(res.body.issue_title, "testupdated1");
          done();
        });
    }).timeout(20000);
  ...
  suite("Tests for PUT method", function () {
    ...
    test("Update multiple fields on an issue: PUT request to /api/issues/{project}", function (done) {
      chai
        ...
        .send({
          _id: issue2._id,
          issue_title: "testupdatedforissue2",
          issue_text: "testtesttest",
          created_by: "Ayne Abreham updated",
          assigned_to: "who",
          status_text: "stat",
        })
        .end(function (err, res) {
